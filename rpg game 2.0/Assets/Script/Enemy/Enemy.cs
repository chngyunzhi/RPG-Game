...
public class Enemy : Entity     // for all enemy
{
    ...
    public virtual RaycastHit2D IsPlayerDetected() => Physics2D.Raycast(wallCheck.position, Vector2.right * facingDir, 10, player);
